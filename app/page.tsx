...
const DB:any={
  EN:{words:["lorem","ipsum","health","business","politics","social","sports","education","tech","food","travel"], health:["Healthy life needs daily exercise and yoga","Drink water and eat green vegetables","Meditation improves mental health"], business:["Business growth needs smart planning","Marketing is key to success"], political:["Democracy is important for every citizen","Elections decide the future of the country","Vote is the power of common people"], social:["Society grows when people help each other","Social media connects people worldwide"], sports:["Cricket is loved by millions","Daily sports keeps body fit"], education:["Education is the key to success","Teachers build the nation"], tech:["AI is changing the world","Technology makes life easier"], food:["Healthy food keeps you active"], travel:["Travel opens mind and gives experience"], default:["Lorem ipsum dolor sit amet consectetur","This is dummy placeholder text for design"]},
  HI:{words:["स्वास्थ्य","व्यापार","राजनीति","समाज","खेल","शिक्षा","तकनीक","भोजन","यात्रा"], health:["स्वस्थ जीवन के लिए रोज व्यायाम जरूरी है","रोज फल और हरी सब्जियां खाएं","ध्यान से मन शांत रहता है"], business:["व्यापार बढ़ाने के लिए अच्छी योजना चाहिए"], political:["लोकतंत्र में हर नागरिक का वोट महत्वपूर्ण है","चुनाव देश का भविष्य तय करते हैं"], social:["समाज तभी आगे बढ़ता है जब लोग मदद करें"], sports:["क्रिकेट भारत में सबसे लोकप्रिय खेल है","रोज खेलने से शरीर फिट रहता है"], education:["शिक्षा सफलता की कुंजी है"], tech:["AI दुनिया बदल रहा है"], food:["स्वस्थ भोजन से ऊर्जा रहती है"], travel:["यात्रा से अनुभव बढ़ता है"], default:["यह डिज़ाइन के लिए नमूना पाठ है","इसका उपयोग लेआउट के लिए होता है"]},
...
export default function Page(){
  ...
  const getBank=()=>{
    ...
    if(t.includes("politic")||t.includes("rajniti")||t.includes("चुनाव")||t.includes("राजनीति")) return d.political||d.default;
    if(t.includes("social")||t.includes("samaj")||t.includes("समाज")) return d.social||d.default;
    if(t.includes("sport")||t.includes("cricket")||t.includes("football")||t.includes("खेल")) return d.sports||d.default;
    if(t.includes("educat")||t.includes("school")||t.includes("शिक्षा")) return d.education||d.default;
  ...
  // FIXED DOWNLOAD - UTF-8 BOM added for Hindi/Urdu/Bengali etc
  const downloadTxt=()=>{
    const blob = new Blob(["\uFEFF"+out], {type:"text/plain;charset=utf-8"});
    const url = URL.createObjectURL(blob);
    const a = document.createElement("a");
    a.href = url;
    a.download = `lorem-${lang}-${topic}-${count}.txt`;
